    ...
    <div class="window">
        ...
        <div class="header">
            <div class="header-logo">
                <img v-lazy="`${imgUrl}/assets/flashq.svg`" alt="SVG" class="logo" @click="open_drawer" style="width:50px;height:50px;">
            </div>
        ...
        <div class="body3">
            <div class="word3">
                <div style="font-size: 60px; color: white; font-family: Arial, Helvetica, sans-serif;">极速创建</div>
                <TextAnimation :dText="['调查问卷', '考试试卷', '报名表', '投票问卷']" :fontSize="'60px'" :fontColor="'white'"></TextAnimation>
            </div>
            <img v-lazy="`${imgUrl}/assets/icon3.png`" class="icon3"> 
        </div>
        <div class="body1">
            <div class="word1">
                <TextAnimation :dText="['手机端', '平板端', '电脑端']" :fontSize="'60px'" :fontColor="'rgb(38, 111, 185)'"></TextAnimation>
                <div style="font-size: 60px; color: rgb(38, 111, 185); font-family: Arial, Helvetica, sans-serif;">随处可用</div> 
            </div>
            <img v-lazy="`${imgUrl}/assets/icon1.png`" class="icon1"> 
        </div>
        <div class="body2">
            <div class="word2">
                <TextAnimation :dText="['数据分析', '交叉分析']" :fontSize="'60px'" :fontColor="'rgb(38, 111, 185)'"></TextAnimation>
                <div style="font-size: 60px; color: rgb(38, 111, 185); font-family: Arial, Helvetica, sans-serif;">无所不能</div> 
            </div>
            <img v-lazy="`${imgUrl}/assets/icon2.png`" class="icon2"> 
        </div>
    </div>
</template>
